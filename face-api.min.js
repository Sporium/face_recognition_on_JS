!(function (t, e) {
			...
			(t.prototype.fromPixels = function (t, e) {
				...
				if (null != t.getContext)
					...
					(this.fromPixels2DContext.canvas.width = t.width),
						(this.fromPixels2DContext.canvas.height = t.height),
						this.fromPixels2DContext.drawImage(t, 0, 0, t.width, t.height),
						(n = this.fromPixels2DContext.getImageData(0, 0, t.width, t.height)
							.data);
				}
	...
	function Vl(t, e, n) {
		return (
			...
			Hl(t, 'number' == typeof e || 'boolean' == typeof e ? [e] : e, function (
				t,
				e
			) {
		...
		df = (function (n) {
			...
			return (
				...
				(t.prototype.forwardInput = function (e) {
					...
					return ue(function () {
						var t = Ep(e.toBatchTensor(112, !0), [
								122.782,
								117.001,
								104.298,
							]).div(Ve(256)),
	...
	var Mf = (function (t) {
		...
		return (
			...
			(e.prototype.forwardInput = function (n) {
				...
				return ue(function () {
					var t = kf(
							Ep(n.toBatchTensor(150, !0).toFloat(), [
								122.782,
								117.001,
								104.298,
							]).div(Ve(256)),
